...
public class VaulterLeapAtTargetGoal extends Goal {
   ...
   public VaulterLeapAtTargetGoal(Mob p_25492_, float p_25493_) {
      this.mob = p_25492_;
      this.yd = p_25493_;
   ...
   public void start() {
      ...
      if (this.mob.hasEffect(SEEffects.VAULTER.get())) {
         this.mob.setDeltaMovement(vec31.x, (double) this.yd  * 1.5, vec31.z);
      } else {
