...
public class GoatCorpseRender extends GeoEntityRenderer<GoatCorpse> {

    public GoatCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new GoatCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, GoatCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
