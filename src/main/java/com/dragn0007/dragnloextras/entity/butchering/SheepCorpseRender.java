...
public class SheepCorpseRender extends GeoEntityRenderer<SheepCorpse> {

    public SheepCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new SheepCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, SheepCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
