...
public class CaribouCorpseRender extends GeoEntityRenderer<CaribouCorpse> {

    public CaribouCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new CaribouCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, CaribouCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
