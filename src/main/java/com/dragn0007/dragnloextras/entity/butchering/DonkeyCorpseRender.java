...
public class DonkeyCorpseRender extends GeoEntityRenderer<DonkeyCorpse> {

    public DonkeyCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new DonkeyCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, DonkeyCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
