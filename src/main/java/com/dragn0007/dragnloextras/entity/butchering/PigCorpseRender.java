...
public class PigCorpseRender extends GeoEntityRenderer<PigCorpse> {

    public PigCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new PigCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, PigCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
