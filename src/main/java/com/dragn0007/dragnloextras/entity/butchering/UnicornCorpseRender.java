...
public class UnicornCorpseRender extends GeoEntityRenderer<UnicornCorpse> {

    public UnicornCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new UnicornCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, UnicornCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
