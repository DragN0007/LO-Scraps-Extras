...
public class FarmGoatCorpseRender extends GeoEntityRenderer<FarmGoatCorpse> {

    public FarmGoatCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new FarmGoatCorpseModel());
    }

    @Override
    public void preRender(PoseStack poseStack, FarmGoatCorpse entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
