...
public class CowCorpseRender extends GeoEntityRenderer<CowCorpse> {

    public CowCorpseRender(EntityRendererProvider.Context renderManager) {
        super(renderManager, new CowCorpseModel());
    }
