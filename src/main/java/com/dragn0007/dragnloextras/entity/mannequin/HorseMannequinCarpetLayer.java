...
@OnlyIn(Dist.CLIENT)
public class HorseMannequinCarpetLayer extends GeoRenderLayer<HorseMannequin> {
    ...
    public HorseMannequinCarpetLayer(GeoRenderer<HorseMannequin> entityRendererIn) {
        super(entityRendererIn);
    }

    @Override
    public void render(PoseStack poseStack, HorseMannequin animatable, BakedGeoModel bakedModel, RenderType renderType, MultiBufferSource bufferSource, VertexConsumer buffer, float partialTick, int packedLight, int packedOverlay) {
        ...
        if (!itemStack.isEmpty()) {
            ...
            if (armorItemStack.isEmpty()) {
                if (itemStack.is(LOTags.Items.CARPET_BLANKETS)) {
                    resourceLocation = HorseMannequinCarpetLayer.CARPET_COLOR[((WoolCarpetBlock) Block.byItem(itemStack.getItem())).getColor().getId()];
                } else if (itemStack.is(LOTags.Items.MEDIEVAL_BLANKETS)) {
                    resourceLocation = HorseMannequinCarpetLayer.MEDIEVAL_COLOR[((BlanketItem) itemStack.getItem()).getColor().getId()];
                } else if (itemStack.is(LOTags.Items.MODERN_BLANKETS)) {
                    resourceLocation = HorseMannequinCarpetLayer.MODERN_COLOR[((BlanketItem) itemStack.getItem()).getColor().getId()];
                } else if (itemStack.is(LOTags.Items.RACING_BLANKETS)) {
                    resourceLocation = HorseMannequinCarpetLayer.RACING_COLOR[((BlanketItem) itemStack.getItem()).getColor().getId()];
                } else if (itemStack.is(LOTags.Items.WESTERN_BLANKETS)) {
                    resourceLocation = HorseMannequinCarpetLayer.WESTERN_COLOR[((BlanketItem) itemStack.getItem()).getColor().getId()];
                } else if (itemStack.getItem() instanceof BlanketItem blanketItem) {
        ...
        if (animatable.hasHalter()) {
            DyeColor dyeColor = animatable.getHalterColor();
            if (dyeColor != null) {
