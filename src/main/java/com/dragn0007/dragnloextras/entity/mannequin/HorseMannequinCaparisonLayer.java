...
@OnlyIn(Dist.CLIENT)
public class HorseMannequinCaparisonLayer extends GeoRenderLayer<HorseMannequin> {

    public HorseMannequinCaparisonLayer(GeoRenderer<HorseMannequin> entityRendererIn) {
