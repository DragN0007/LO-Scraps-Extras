...
@OnlyIn(Dist.CLIENT)
public class HorseMannequinSaddleLayer extends GeoRenderLayer<HorseMannequin> {
    public HorseMannequinSaddleLayer(GeoRenderer<HorseMannequin> entityRendererIn) {
