...
@OnlyIn(Dist.CLIENT)
public class HorseMannequinArmorLayer extends GeoRenderLayer<HorseMannequin> {
    public HorseMannequinArmorLayer(GeoRenderer<HorseMannequin> entityRendererIn) {
