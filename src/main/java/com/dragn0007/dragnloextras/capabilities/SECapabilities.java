...
public interface SECapabilities {
    ...
    Capability<SpikeCollarCapabilityInterface> SPIKE_COLLAR_CAPABILITY = CapabilityManager.get(new CapabilityToken<>() {});
    ...
    static void register(RegisterCapabilitiesEvent event) {
        ...
        event.register(SpikeCollarCapabilityInterface.class);
    }
}