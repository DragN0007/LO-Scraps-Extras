...
public class ParasiticOintmentItem extends Item {

    public ParasiticOintmentItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (ScrapsExtrasCommonConfig.TREATMENTS.get()) {
            pTooltipComponents.add(Component.translatable("Cures Parasitic Infestations in animals.").withStyle(ChatFormatting.GRAY));
        } else {
