...
public class EardropsItem extends Item {

    public EardropsItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (ScrapsExtrasCommonConfig.TREATMENTS.get()) {
            pTooltipComponents.add(Component.translatable("Cures Ear Infections in animals.").withStyle(ChatFormatting.GRAY));
        } else {
