...
public class AntibioticOintmentItem extends Item {

    public AntibioticOintmentItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (ScrapsExtrasCommonConfig.TREATMENTS.get()) {
            pTooltipComponents.add(Component.translatable("Cures Skin Infections in animals.").withStyle(ChatFormatting.GRAY));
        } else {
