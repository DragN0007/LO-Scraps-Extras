...
public class AntibioticInjectionItem extends Item {

    public AntibioticInjectionItem(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        if (ScrapsExtrasCommonConfig.TREATMENTS.get()) {
            pTooltipComponents.add(Component.translatable("Cures Infections in animals.").withStyle(ChatFormatting.GRAY));
        } else {
